...
public class ColumnComparators implements Serializable {
    ...
    private ColumnComparators(
            ...
            Double defaultVarianceThreshold,
            Map<String, Builder.ToleranceVarianceValues> values) {
    ...
    public CellComparator getComparatorForRebase(String columnName) {
        CellComparatorPair cellComparators = this.comparatorsByColumn.get(columnName);
        return cellComparators == null
                ? this.defaultCellComparator.getRebaseComparator()
                : cellComparators.getRebaseComparator();
    }
    ...
    public static class Builder {
        ...
        public Builder withTolerance(String columnName, double tolerance) {
            this.toleranceVarianceValues.put(
                    columnName, toleranceVarianceValue(columnName).withTolerance(tolerance));
            return this;
        }
        ...
        public Builder withVarianceThreshold(String columnName, double varianceThreshold) {
            this.toleranceVarianceValues.put(
                    columnName, toleranceVarianceValue(columnName).withVarianceThreshold(varianceThreshold));
            return this;
        }

        public ColumnComparators build() {
            return new ColumnComparators(
                    this.defaultTolerance,
                    this.defaultVarianceThreshold,
                    Collections.unmodifiableMap(this.toleranceVarianceValues));
        }
        ...
        private ToleranceVarianceValues toleranceVarianceValue(String columnName) {
            return this.toleranceVarianceValues.get(columnName) == null
                    ? new ToleranceVarianceValues()
                    : this.toleranceVarianceValues.get(columnName);
        }
