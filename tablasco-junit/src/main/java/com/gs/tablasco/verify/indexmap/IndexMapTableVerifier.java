...
public class IndexMapTableVerifier implements SingleTableVerifier
{
    ...
    public ResultTable verify(VerifiableTable actualData, VerifiableTable expectedData)
    {
        if (actualData == null)
        {
            return new ResultTable(new boolean[expectedData.getColumnCount()], toListOfRows(expectedData, (columnName, value) -> ResultCell.createMissingCell(columnComparators.getComparator(columnName).getFormatter(), value)));
        }
    ...
    private List<List<ResultCell>> toListOfRows(VerifiableTable verifiableTable, BiFunction<String, Object, ResultCell> cellFunction)
    {
    ...
    private static void verifyHeaders(List<IndexMap> columnIndices, List<List<ResultCell>> results, VerifiableTable actualData, VerifiableTable expectedData, CellComparator comparator)
    {
    ...
    private static void collectMatchingRows(List<IndexMap> columnIndices, List<List<ResultCell>> results, VerifiableTable actualData, VerifiableTable expectedData, ColumnComparators columnComparators)
    {
    ...
    private static void collectReverseMatchingRows(List<IndexMap> columnIndices, List<List<ResultCell>> reverseHappyPathResults, VerifiableTable actualData, VerifiableTable expectedData, ColumnComparators columnComparators, int firstUnMatchedIndex)
    {
    ...
    private static boolean checkRowMatches(List<IndexMap> columnIndices, List<List<ResultCell>> results, VerifiableTable actualData, VerifiableTable expectedData, ColumnComparators columnComparators, int actualIndex, int expectedIndex, List<ResultCell> row)
    {
        for (IndexMap column : columnIndices)
        {
            if (column.isMissing())
    ...
    private void buildResults(List<IndexMap> columnIndices, List<IndexMap> finalRowIndices, List<List<ResultCell>> results, List<List<ResultCell>> reverseResults, VerifiableTable actualData, VerifiableTable expectedData, ColumnComparators columnComparators)
    {
    ...
    private static void addSurplusRecord(IndexMap rowIndexMap, List<ResultCell> row, IndexMap colIndexMap, VerifiableTable actualData, ColumnComparators columnComparators)
    {
    ...
    private static void addMissingRecord(IndexMap rowIndexMap, List<ResultCell> row, IndexMap colIndexMap, VerifiableTable expectedData, ColumnComparators columnComparators)
    {
    ...
    private static void addMatchedRecord(IndexMap rowIndexMap, List<ResultCell> row, IndexMap colIndexMap, VerifiableTable actualData, VerifiableTable expectedData, ColumnComparators columnComparators)
    {
    ...
    private static void mergePartialMatches(List<IndexMap> finalRowIndices, List<UnmatchedIndexMap> allMissingRows, List<UnmatchedIndexMap> allSurplusRows)
    {
    ...
    private List<IndexMap> getColumnIndices(VerifiableTable actualData, VerifiableTable expectedData, CellComparator comparator)
    {
