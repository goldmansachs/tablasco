...
{
    public ActualRowIterator(VerifiableTable table, MutableList<IndexMap> columns, ColumnComparators columnComparators, int initialIndex, int lastUnMatchedOffset)
    {
