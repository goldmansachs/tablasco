...
public class SingleTableVerifierMaxBestMatchThresholdTest extends AbstractSingleTableVerifierTest {
    ...
    static {
        ...
        addVerification("columnHeadersMatch", row(pass("Entity"), pass("Account"), pass("Notional")));
        addVerification(
        ...
        addVerification(
                "missingColumnAtFront", row(missing("column1"), pass("column2"), pass("column3"), pass("column4")));
        addVerification(
                "missingColumnAtEnd", row(pass("column1"), pass("column2"), pass("column3"), missing("column4")));
        addVerification(
                "missingColumnInMiddle", row(pass("column1"), missing("column2"), pass("column3"), pass("column4")));
        addVerification(
        ...
        addVerification(
                "outOfOrderColumns3", row(outOfOrder("column4"), pass("column1"), pass("column2"), pass("column3")));
        addVerification("outOfOrderColumns4", row(outOfOrder("column3"), outOfOrder("column2"), pass("column1")));
        addVerification(
                "outOfOrderColumns", row(pass("column1"), pass("column2"), outOfOrder("column4"), pass("column3")));
        addVerification(
                "surplusRowAtStart",
                row(pass("column1"), pass("column2"), pass("column3")),
                row(surplus("--d--"), surplus("--e--"), surplus("--f--")),
